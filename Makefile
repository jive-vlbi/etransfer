...
# etransfer daemon
etd_SRC=src/etd.cc src/reentrant.cc src/etdc_fd.cc src/etdc_etdserver.cc src/etdc_debug.cc src/etd_acl.cc src/etdc_auth.cc
...
# etransfer client
etc_SRC=src/etc.cc src/reentrant.cc src/etdc_fd.cc src/etdc_etdserver.cc src/etdc_debug.cc src/etd_acl.cc src/etdc_auth.cc
...
tAUTH_SRC=src/tAUTH.cc src/etdc_auth.cc
tAUTH_VERSION=0
